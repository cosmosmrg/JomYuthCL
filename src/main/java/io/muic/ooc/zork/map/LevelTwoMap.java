 ...
 */
public class LevelTwoMap implements GameMap {
    ...
    public void terminate() {
        System.out.println("Congratulations, you passed the level 2");
    }
