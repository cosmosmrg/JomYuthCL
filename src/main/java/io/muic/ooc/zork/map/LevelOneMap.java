...
public class LevelOneMap implements GameMap {
    ...
    public void create(){
        ...
        monsterFactory.init();
        itemFactory.init();
        List<Monster> monsters = monsterFactory.createMonster(1,10);
    ...
    public void terminate() {
        System.out.println("Congratulations, you passed the level 1");
    }
